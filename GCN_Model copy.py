...
class Model(torch.nn.Module):
    def __init__(self, num_features=size_input, hidden_size=size_hidden, num_classes=size_output, model_embedding=model_embedding):
        super(Model, self).__init__()
        self.hidden_size = hidden_size
        self.num_features = num_features
        self.target_size = num_classes
        self.embedding_model = model_embedding.cuda()
        self.convs = [
